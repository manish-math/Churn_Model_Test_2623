...
from (
  ...
  from ${owner}
  where
  fca_id in (select distinct fca_id from churn_bnso_retail_base_part1)
...
from date_vhcl_dispsl a inner join churn_bnso_retail_base_part1 b 
...
from (
    ...
    from churn_bnso_retail_base_part1 a 
...
SELECT distinct a.*,COALESCE(vin_disp_30,0) vin_disp_30,COALESCE(vin_disp_90,0) vin_disp_90
from base2 
