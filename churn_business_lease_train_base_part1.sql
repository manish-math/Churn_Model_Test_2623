...
SELECT fca_id,i_consmr,'Business_Lease' as status,retail_lease_flag,i_hshld_id_curr,vin,l_new_vhcl,c_sales_typ_orig,d_purchase,true_disp, x_vhcl_make, x_nmplt
from (
...
where p_rank=1
and true_disp >= '${train_ref_date}'
-- and fca_id not in (select fca_id from churn_bnso_buso_retail_lease)