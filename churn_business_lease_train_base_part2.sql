...
from (
  ...
  from ${owner}
  where
  fca_id in (select distinct fca_id from churn_business_lease_train_base_part1)
...
from churn_business_lease_train_base_part1 a
...
from churn_business_lease_train_base_part1
where
