...
-- left join 
-- avg_vin_ownership_tenure_bnso_lease_churn_scoring
...
-- left join 
-- nVehicles_purchased_bnso_lease_churn_scoring
-- f on trim(a.fca_id)=trim(f.fca_id)
-- left join 
-- avg_serv_spend_bnso_lease_churn_scoring
...
-- left join
-- ttl_act_new_vhcl_own_last_5_yr_bnso_lease_churn_scoring
-- j on trim(a.fca_id)=trim(j.fca_id)
-- left join 
-- disp_ratio_bnso_lease_churn_scoring
