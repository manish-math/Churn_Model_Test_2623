...
SELECT distinct a.fca_id,a.vin,type_vehicle
,COALESCE(recall_type_federal_emissn,0) as recall_type_federal_emissn,household_type ,d_recal_lnch
...
get_fca_lvl as (
select a.fca_id,vin,type_vehicle,recall_type_federal_emissn,household_type,d_recal_lnch
...
select distinct fca_id,max(recall_type_federal_emissn) recall_type_federal_emissn
from get_fca_lvl
group by 1