...
case when mileage_recorded_from_last_service_for_active_owned_std between 0 and 15000 then 'mileage_recorded 0-15000' 
when mileage_recorded_from_last_service_for_active_owned_std between 16000 and 25000 then 'mileage_recorded 16000-25000' 
when mileage_recorded_from_last_service_for_active_owned_std between  26000 and 35000 then 'mileage_recorded 26000-35000'
when mileage_recorded_from_last_service_for_active_owned_std between  36000 and 45000 then'mileage_recorded 36000-45000' 
when mileage_recorded_from_last_service_for_active_owned_std >45000 then 'mileage_recorded >45000' 
end as mileage_recorded_from_last_service_for_active_owned_std
from (
...
from (
  (
    select fca_id,vin ,retail_lease_flag
    from ${business_retail_base}
  ) as base_table
  left join
  (
      ...
      (
        ...
        (
          ...
          (
            ...
            (
              (
                select fca_id,vin,d_purchase,true_disp,retail_lease_flag
                from ${business_retail_base}
              ) as T1
            left join
            (
              ...
              and i_vin in (SELECT DISTINCT vin from ${business_retail_base})
