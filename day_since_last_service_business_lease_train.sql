          ...
          (
            ...
            (
              ...
              from
                ...
                (
                  ...
                  and fca_id in (select distinct fca_id from ${business_lease_base})
                  and i_vin_first_9||i_vin_last_8 in (select distinct vin from ${business_lease_base})
                  and c_cntry_srce = '1'
            ...
            left join
              (
                ...
                and i_vin in (select distinct vin from ${business_lease_base})
...
date_diff('day',date(last_serv_date),date('${train_ref_date}')) as days_since_last_service 
from (
select fca_id,vin,max(d_ro_invc) last_serv_date from days_since_last_service_base
group by 1,2 
)