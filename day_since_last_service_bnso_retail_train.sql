          ...
          (
            ...
            (
              ...
              from
                ...
                (
                  ...
                  and fca_id in (select distinct fca_id from ${bnso_retail_train_base})
                  and i_vin_first_9||i_vin_last_8 in (select distinct vin from ${bnso_retail_train_base})
                  and c_cntry_srce = '1'
            ...
            left join
              (
                ...
                and i_vin in (select distinct vin from ${bnso_retail_train_base})
