          ...
          (
            ...
            (
              ...
              from
                ...
                (
                  ...
                  and i_vin_first_9||i_vin_last_8 in (select distinct vin from ${bnso_lease_train_base})
                  and c_cntry_srce = '1'
            ...
            left join
              (
                ...
                and i_vin in (select distinct vin from ${bnso_lease_train_base})
...
select distinct fca_id,vin,date_diff('day',date(last_serv_date),date('${train_ref_date}')) as days_since_last_service from (
